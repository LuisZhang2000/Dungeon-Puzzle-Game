...
Epic Story 1 and Epic Story 4
Epic 1 Epic 4 User Stories, Acceptance Criteria, Story Points and Priorities

Matthew:

Epic Story 2 and Epic Story 3
Epic 2 and Epic 3 User Stories, Acceptance Criteria, Story Points and Priorities


### Week-06

Luis: 
Created classes for UML diagram
Implemented classes for each entity and state design pattern for doors

Matthew: 
Created classes for UML diagram
Worked on obstacles and collision detection


### Week-07

Luis: exit, started goal classes, inventory for key, treasure, sword and potion,
updated dungeon class with attributes and methods for inventory and goal,
updated uml diagram

Matthew: boulder, strategy pattern for movement, enemy behaviour, 
helped with sword and potion inventories, implemented composite pattern for goal classes, 
portal, switch, sword


### Week-08

Luis: Implementing the menu ui, level selection ui, finishing the UML diagram

Matthew: Test for the dungeon, implementing the inventory ui

### Week-09

Luis: Tutorial Screen, tutorial level, stage1-3 json, mainmenu (co-op), pause/resume

Matthew: mainmenu (co-op), inventory gui, goals gui, door open gui, level selection
